...
## Steps
1. Read `harness/01-PRD.md`, `harness/02-USER-STORIES.md`, and the intake source
   (`00-INTAKE.md` or `00-CODEBASE-MAP.md`). Load `templates/TRD.md`.
...
5. Do not invent libraries/APIs. Flag any needed new dependency explicitly for user approval
   (do not assume it).
6. Write `harness/03-TRD.md`; set `current_stage: trd`, `gates.trd: pending`.
7. Tell the user to review, run `/sdlc:gate`, then `/sdlc:implement`.
