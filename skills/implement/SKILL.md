...
## Steps
1. Read `harness/03-TRD.md` and `harness/02-USER-STORIES.md`. Build the ordered list of
   stories (respect priority / dependencies).
2. For **each story**, dispatch the **implementer** sub-agent with: the story + its ACs, the
   ...
   changes stay scoped and traceable.
...
5. Tell the user to review the code, run `/sdlc:gate`, then `/sdlc:test`.
